...
- upgrades nashcash-wallet-backend for some transaction bugfixes
...
- bumps nashcash-wallet-backend version
...
- nashcash-wallet-backend-js version upgraded, now connects to daemon with KeepAlive = true
...
- bumps nashcash-wallet-backend-js dependency to latest version
...
- upgrade the nashcash-wallet-backend dependency to fix a bug that was caused by a batch of blocks in the ~200k range, also no longer checks for an update in development mode
