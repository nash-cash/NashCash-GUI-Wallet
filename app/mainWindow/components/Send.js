        ...
        const modalMessage = (
          <div>
            ...
            <p className={`subtitle ${textColor}`}>
              ...
              <br />
              {atomicToHuman(amount + nodeFee + fee, true)} NaCa
            </p>
            <p className={`subtitle ${textColor}`}>
              <b>Fee:</b>
              <br />
              {atomicToHuman(nodeFee + fee, true)} NaCa
              {nodeFee > 0 &&
    ...
    const transactionData = {
      ...
      amount:
        displayCurrency === 'NaCa'
          ...
          : (Number(enteredAmount) * 100000000) / fiatPrice,
      paymentID,
      sendAll
    };
    ...
    const addressInput = (
      ...
      >
        <Creatable
          ...
          placeholder="Enter a NashCash address or a contact name to send funds to"
